...
| 层 | 目录 | 当前职责 |
| --- | --- | --- |
| 启动编排层 | `src/pb2025_sentry_bringup` | 实机 / loopback 总入口、参数整合、地图/PCD/RViz |
| 决策层 | `src/pb2025_sentry_behavior` | 行为树、视觉接管、姿态切换、路径生成、资源门控 |
| 导航与定位层 | `src/pb2025_sentry_nav` | Nav2、MPPI、B 样条、Traversability ESDF、恢复行为、重定位、点云链 |
...
- 启动文件：
  [../src/pb2025_sentry_nav/pb2025_nav_bringup/launch/rm_navigation_reality_launch.py](../src/pb2025_sentry_nav/pb2025_nav_bringup/launch/rm_navigation_reality_launch.py)
- 默认参数：
...
- B 样条优化器：
  [../src/pb2025_sentry_nav/trajectory_optimizer/src/bspline_path_optimizer.cpp](../src/pb2025_sentry_nav/trajectory_optimizer/src/bspline_path_optimizer.cpp)
- Nav2 smoother 插件：
  [../src/pb2025_sentry_nav/trajectory_optimizer/src/nav2_bspline_smoother.cpp](../src/pb2025_sentry_nav/trajectory_optimizer/src/nav2_bspline_smoother.cpp)
- Traversability ESDF：
  [../src/pb2025_sentry_nav/trajectory_optimizer/src/traversability_esdf_provider.cpp](../src/pb2025_sentry_nav/trajectory_optimizer/src/traversability_esdf_provider.cpp)
- governor：
  [../src/pb2025_sentry_nav/trajectory_optimizer/src/trajectory_speed_governor.cpp](../src/pb2025_sentry_nav/trajectory_optimizer/src/trajectory_speed_governor.cpp)
...
- `small_gicp` 重定位：
  [../src/pb2025_sentry_nav/small_gicp_relocalization/src/small_gicp_relocalization.cpp](../src/pb2025_sentry_nav/small_gicp_relocalization/src/small_gicp_relocalization.cpp)
