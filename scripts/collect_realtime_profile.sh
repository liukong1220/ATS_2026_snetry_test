...
# Match the RMUC 2025 field height and wheel contact geometry used by the
# navigation launch; do not lift the robot above the hfield for profiling.
export START_Z="${START_Z:-0.381}"
