...
#include "ats_sentry_behavior/ats_sentry_behavior_client.hpp"
...
: Node("sentry_behavior_client", options)
{
  ...
  action_client_ = rclcpp_action::create_client<BTExecuteTree>(this, "ats_sentry_behavior");
...
RCLCPP_COMPONENTS_REGISTER_NODE(ats_sentry_behavior::SentryBehaviorClient)
