...
- [launch/ats_sentry_behavior_launch.py](./launch/ats_sentry_behavior_launch.py)
...
2. 改 planner / MPPI / smoother / 恢复行为，不在本包改，去 `ats_sentry_nav`
3. 改实机总启动、参数整合、loopback 假输入，不在本包改，去 `ats_sentry_bringup`
