#include "ats_sentry_behavior/plugins/condition/is_game_time_stage.hpp"
...
{
  factory.registerNodeType<ats_sentry_behavior::IsGameTimeStageCondition>("IsGameTimeStage");
}
