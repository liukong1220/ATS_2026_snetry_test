...
#include "ats_sentry_behavior/plugins/decorator/tick_after_timeout_node.hpp"
...
{
  factory.registerNodeType<ats_sentry_behavior::TickAfterTimeout>("TickAfterTimeout");
}
