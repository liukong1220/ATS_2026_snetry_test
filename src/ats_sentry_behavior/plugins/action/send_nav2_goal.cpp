...
#include "ats_sentry_behavior/plugins/action/send_nav2_goal.hpp"

#include "ats_sentry_behavior/custom_types.hpp"
...
CreateRosNodePlugin(ats_sentry_behavior::SendNav2GoalAction, "SendNav2Goal");
