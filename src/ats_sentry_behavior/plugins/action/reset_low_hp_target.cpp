#include "ats_sentry_behavior/plugins/action/reset_low_hp_target.hpp"
...
{
  factory.registerNodeType<ats_sentry_behavior::ResetLowHpTargetAction>("ResetLowHpTarget");
}
