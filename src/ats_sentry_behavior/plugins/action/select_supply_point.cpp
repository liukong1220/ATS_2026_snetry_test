#include "ats_sentry_behavior/plugins/action/select_supply_point.hpp"
...
{
  factory.registerNodeType<ats_sentry_behavior::SelectSupplyPointAction>("SelectSupplyPoint");
}
