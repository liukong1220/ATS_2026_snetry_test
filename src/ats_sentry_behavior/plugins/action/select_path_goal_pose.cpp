#include "ats_sentry_behavior/plugins/action/select_path_goal_pose.hpp"
...
{
  factory.registerNodeType<ats_sentry_behavior::SelectPathGoalPoseAction>("SelectPathGoalPose");
}
