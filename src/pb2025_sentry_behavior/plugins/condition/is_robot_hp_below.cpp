#include "pb2025_sentry_behavior/plugins/condition/is_robot_hp_below.hpp"
...
{
  factory.registerNodeType<pb2025_sentry_behavior::IsRobotHpBelowCondition>("IsRobotHpBelow");
}
